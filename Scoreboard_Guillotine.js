...
if ($('#body_ajax_ls').length) {
    if ($('script[src*="mfl_live_scoring.js"]').length === 0 || liveScoringWeek === 0) {
        ...
        function ls_error_check() {
            ...
            var errorClassCk = setInterval(function () {
                if (ls_has_triggered) {
                    ...
                    $('head').append('<style>#body_ajax_ls #myNavigationHolder,\
        ...
        function ls_append_css() {
            $('head').append(`
                <style>
                    .LS_MainScoreboard .ls_team_name {
                    white-space: nowrap;
                    }

                    .ls_other_game .ls_og_full_name,
                    .LS_MainScoreboard .ls_team_name {
                    overflow: hidden;
                    text-overflow: ellipsis;
                    }

                    .ls-outer-table td.ls_game_info br {
                    display: none;
                    }

                    .ls-outer-table td.ls_game_info br + br {
                    display: block;
                    }

                    td.ls_projections span:empty:before {
                    content: "0";
                    }

                    .ls-matchup caption span {
                    max-width: unset !important;
                    }

                    .ls_player_stats div:empty:before {
                    content: "- stats - ";
                    }
                    ...
                    #body_ajax_ls #ls_ticker_tab_id,
                    #ls_ticker_tab_id + p,
                    #body_ajax_ls #ls_ticker_tab_id + p + p,
                    #body_ajax_ls #ls_ticker_tab_id + p + p + p,
                    ...
                    #other_games > tbody > tr > td {
                    font-size: 0;
                    }

                    #other_games div.ls_other_game {
                    margin: 0 0.125rem;
                    font-size: 0.813rem;
                    }

                    #body_ajax_ls #ls-modal-container.hide-overlay .ls-modal-content {
                    display: none;
                    }

                    #body_ajax_ls #other_games td.ls_og_cell {
                    font-size: 0.813rem;
                    }

                    #body_ajax_ls #nfl_games td.ls_box_possession:after {
                    content: "";
                    ...
                    #body_ajax_ls #nfl_games td.ls_box_possession.ls_has_ball+td,
                    #body_ajax_ls #nfl_games td.ls_box_possession.ls_in_redzone+td {
                    width: 5.625rem;
                    }

                    #body_ajax_ls #nfl_games td.ls_box_possession.ls_has_ball,
                    #body_ajax_ls #nfl_games td.ls_box_possession.ls_in_redzone {
                    width: 2.625rem;
                    }

                    #body_ajax_ls #nfl_games td.ls_box_possession.ls_in_redzone:after {
                    background-image: url(https://www.mflscripts.com/ImageDirectory/script-images/goal-post.svg);
                    }

                    #body_ajax_ls #nfl_games td.ls_box_possession.ls_has_ball:after {
                    background-image: url(https://www.mflscripts.com/ImageDirectory/script-images/football.svg);
                    }

                    #body_ajax_ls #nfl_games div.ls_other_game td {
                    padding: 0.063rem 0.125rem;
                    }

                    #nfl_games td[style="border:none;"]:last-of-type {
                    padding: 0 !important;
                    }
                    ...
                    #ls-modal-content .ls-popup-player-li:last-child {
                    border: 0;
                    }
                    ...
                    font-weight: 400;
                    padding: 0.125rem 0 0.125rem 0.188rem;
                    max-width: 21.875rem;
                    }
                    ...
                    #ls-modal-content span.ls-popup-text {
                    font-style: italic;
                    font-weight: 700;
                    }

                    .ls-popup-text::before,
                    .ls-popup-icon-wrapper::before {
                    content: "-";
                    padding: 0 0.125rem;
                    }

                    #ls-modal-content img.ls-popup-icon {
                    max-height: 1rem;
                    max-width: 5rem;
                    }
                    ...
                    #body_ajax_ls th.ls_projections {
                    width: 6.25rem;
                    }

                    #body_ajax_ls td.ls_marquee_value {
                    padding-left: 0;
                    padding-right: 0;
                    }

                    #body_ajax_ls .ls-matchup th:last-of-type,
                    #body_ajax_ls .ls-matchup td:last-of-type {
                    width: 3.125rem;
                    }

                    .ls_other_game .ls_projections {
                    cursor: pointer;
                    }

                    .ls_pace_box .ls_projected {
                    display: none;
                    }
                    ...
                    #ls-modal-content .ls-popup-stats { max-width: 17.5rem; }
                    }
                    @media only screen and (max-width:22.5em) {
                    #ls-modal-content .ls-popup-stats { max-width: 12.5rem; }
                    }
                    @media only screen and (max-width:20em) {
                    #ls-modal-content .ls-popup-stats { max-width: 11.25rem; }
                    }
                    @media only screen and (max-height:37.5em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 28.75rem; }
                    }
                    @media only screen and (max-height:31.25em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 22.5rem; }
                    }
                    @media only screen and (max-height:28.125em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 19.375rem; }
                    }
                    @media only screen and (max-height:25em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 16.25rem; }
                    }
                    @media only screen and (max-height:21.875em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 13.125rem; }
                    }
                    @media only screen and (max-height:18.75em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 10rem; }
                    }
                    @media only screen and (max-height:15.625em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 6.875rem; }
                    }
                    @media only screen and (max-height:12.5em) and (orientation:landscape) {
                    #ls-modal-content { max-height: 9.375rem; }
                    }

                    @media only screen and (max-width:70em) {
                    #body_ajax_ls .ls-matchup td.ls_projections,
                    #body_ajax_ls th.ls_projections { width: 5rem; }
                    }
                    @media only screen and (max-width:60em) {
                    #body_ajax_ls .ls-matchup td.ls_projections,
                    #body_ajax_ls th.ls_projections { width: 3.75rem; }
                    }
                    @media only screen and (max-width:55em) {
                    #body_ajax_ls .ls-matchup td.ls_projections,
                    #body_ajax_ls th.ls_projections { width: 2.5rem; }
                    }
                    @media only screen and (max-width:48em) {
                    #body_ajax_ls .ls-matchup td.ls_projections,
                    #body_ajax_ls th.ls_projections { width: 8.75rem; }
                    }
                    ...
                    @media only screen and (max-width:30em) {
                    .ls_pace_legend_title { display: block; }
                    #body_ajax_ls .ls-has-bye #LS_TopTableHolder .LS_ScoreboardTitle,
                    #body_ajax_ls .ls-has-bye #LS_TopTableHolder .prmin { font-size: 0.625rem; }
                    }
                    @media only screen and (max-width:25em) {
                    .ls_projected { display: block; }
                    }
        ...
        function build_other_games(home, away) {
            ...
            for (var gid = 0; gid < game_ord.length; gid++) {
                ...
                // ===== NEW: figure out how many rows this block will actually render
                var rowsCount = 0;
                for (var jj = 0; jj < 2; jj++) {
                    if (game[jj] === '') continue;
                    rowsCount += 1; // BYE/AVG/real all count as one row each
                }
                if (rowsCount === 0) rowsCount = 1; // safety

                var rankInserted = false; // track whether we've emitted the rank <td>

                // ===== UPDATED row builder with a rank cell on the first row only
                for (var j = 0; j < 2; j++) {
                    if (game[j] == '') {
                        // skip
                    } else if (game[j] == 'BYE') {
                        html = html + '<tr>';
                        if (!rankInserted) {
                            html = html + '<td class="ls_rank" rowspan="' + rowsCount + '">' + (gid + 1) + '</td>';
                            rankInserted = true;
                        }
                        html = html + '<td class="ls_og_cell">BYE</td><td id="ls_pace_box_BYE" class="ls_pace_box_BYE ls_projections ls_pace_box"' + _style + '></td><td style="border:none;"><div></div></td><td style="border:none;"><div></div></td></tr>\n';
                    } else if (game[j] == 'AVG') {
                        ls_do_avg = 1;
                        html = html + '<tr>';
                        if (!rankInserted) {
                        ...
                        html = html + '<td class="ls_og_cell">AVG</td><td id="ls_pace_box_AVG" class="ls_pace_box_BYE ls_projections ls_pace_box"' + _style + '></td><td align="right" style="border:none;"><div class="ogffpts_avg">0</div></td><td style="border:none;"><div></div></td></tr>\n';
                    } else {
            ...
            function decorateProjectedScoreIntoTeamCell() {
                ...
                cards.forEach(card => {
                    ...
                    // Prefer FINAL points if this card is final
                    let proj;
                    const isFinal = card.classList.contains('game_final') ||
                        Array.from(card.querySelectorAll('td'))
                            .some(td => /\(F\)/i.test((td.textContent || '').trim()));

                    if (isFinal) {
                        const ptsDiv = card.querySelector('div[class^="ogffpts_"]');
                        const m = (ptsDiv && (ptsDiv.textContent || '').match(/-?\d+(?:\.\d+)?/));
                        const finalPts = m ? parseFloat(m[0]) : NaN;
                    ...
                    if (!Number.isFinite(proj)) {
                        ...
                        if (span) {
                            ...
                            if (m) proj = parseFloat(m[0]);
                            if (!Number.isFinite(proj)) {
                                const t = (span.getAttribute('title') || '')
                                    .match(/Original Projection:\s*(-?\d+(?:\.\d+)?)/i);
                                if (t) proj = parseFloat(t[1]);
                            }
                        }
                        if (!Number.isFinite(proj)) {
                            const any = (paceCell.textContent || '').match(/-?\d+(?:\.\d+)?/);
                            proj = any ? parseFloat(any[0]) : NaN;
                        }
                    }
                    ...
                    // Write/update the mirrored line
                    let line = teamCell.querySelector('.ls_proj_line');
                    if (!line) {
                        line = document.createElement('div');
                        line.className = 'ls_proj_line';
    ...
    (function hoistBoxscoreAndWrap() {
        ...
        $tables.each(function (i) {
            ...
            // make sure the boxscore starts hidden, regardless of where it lives
            $('.mobile-wrap.ls-boxscore').addClass('ls-wait');

            $('head').append('<style>\
                #body_ajax_ls .ls-wait { visibility: hidden !important; }\
                </style>');
