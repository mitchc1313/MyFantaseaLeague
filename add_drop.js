		...
		if (addDropContainer) {
			...
			function renderPlayerList(players, containerId, type) {
				...
				filtered.forEach((p, index) => {
					...
					if (type === "drop") {
						if (p.sal) {
							infoLine = `<small>${p.nfl_team ?? 'FA'}${p.bye_week ? ` &bull; Bye: ${p.bye_week}` : ' &bull; Bye: N/A'}${!isNaN(parseFloat(p.adp)) ? ` &bull; ADP: ${parseFloat(p.adp)}` : ' &bull; ADP: N/A'}${!isNaN(parseFloat(p.sort_sal)) ? ` &bull; Sal: $${parseFloat(p.sort_sal)}` : ' &bull; Sal: $0'}</small><input type="hidden" name="PLAYERS" value="${p.id}"><div class="moveBtns"><button type="button" class="move-up-btn" title="Move Player Up 1 Spot">&#x25B2;</button><button type="button" class="move-up-btn-twenty" title="Move Player Up 20 Spots">&#x25B2; 20</button><button type="button" class="move-down-btn" title="Move Player Down 1 Spot">&#x25BC;</button><button type="button" class="move-down-btn-twenty" title="Move Player Down 20 Spots">&#x25BC; 20</button><button type="button" class="move-Up-down-btn-twenty" title="Move Player 20 Spots">&#x25B2; 20 &#x25BC;</button></div>`;
						} else {
							infoLine = `<small>${p.nfl_team ?? 'FA'}${p.bye_week ? ` &bull; Bye: ${p.bye_week}` : ' &bull; Bye: N/A'}${!isNaN(parseFloat(p.adp)) ? ` &bull; ADP: ${parseFloat(p.adp)}` : ' &bull; ADP: N/A'}</small><input type="hidden" name="PLAYERS" value="${p.id}"><div class="moveBtns"><button type="button" class="move-up-btn" title="Move Player Up 1 Spot">&#x25B2;</button><button type="button" class="move-up-btn-twenty" title="Move Player Up 20 Spots">&#x25B2; 20</button><button type="button" class="move-down-btn" title="Move Player Down 1 Spot">&#x25BC;</button><button type="button" class="move-down-btn-twenty" title="Move Player Down 20 Spots">&#x25BC; 20</button><button type="button" class="move-Up-down-btn-twenty" title="Move Player 20 Spots">&#x25B2; 20 &#x25BC;</button></div>`;
						}
					} else {
					...
					if (type === "drop") {
						if (p.sal) {
							...
							if (franchiseOnClock) {
								...
								infoLine += `<input type="hidden" name="PICKS" value="${p.id}"><div class="moveBtns"><button type="button" class="move-up-btn" title="Move Player Up 1 Spot">&#x25B2;</button><button type="button" class="move-up-btn-twenty" title="Move Player Up 20 Spots">&#x25B2; 20</button><button type="button" class="move-down-btn" title="Move Player Down 1 Spot">&#x25BC;</button><button type="button" class="move-down-btn-twenty" title="Move Player Down 20 Spots">&#x25BC; 20</button><button type="button" class="move-Up-down-btn-twenty" title="Move Player 20 Spots">&#x25B2; 20 &#x25BC;</button></div>`;
							}
						} else {
							infoLine += `<small>${p.nfl_team ?? 'FA'}${p.bye_week ? ` &bull; Bye: ${p.bye_week}` : ' &bull; Bye: N/A'}${!isNaN(parseFloat(p.adp)) ? ` &bull; ADP: ${parseFloat(p.adp)}` : ' &bull; ADP: N/A'}</small>`;
							if (franchiseOnClock) {
